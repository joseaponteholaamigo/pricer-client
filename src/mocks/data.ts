...
//
// Categorías, retailers y canales alineados al catálogo canónico
// (`shared/catalog.ts`). Etiquetas canónicas: Lácteos, Cárnicos, Panadería,
// Bebés, etc. (con tildes y nombres unificados con prisier-admin).
...
const skuRaw: [string, string, string, string, number, number, number][] = [
  ...
  ['SKU-013','Leche Entera 1L','LecheSur','Lácteos',3800,2400,18.0],
  ['SKU-014','Yogurt Natural 150g','LecheSur','Lácteos',2100,1200,5.5],
  ['SKU-015','Leche Deslactosada 1L','LecheSur','Lácteos',4200,2700,9.0],
  ['SKU-016','Queso Crema 200g','LecheSur','Lácteos',5600,3100,4.8],
  ['SKU-017','Leche en Polvo 400g','LecheSur','Lácteos',9800,5900,7.2],
  ['SKU-018','Yogurt Griego 200g','LecheSur','Lácteos',3500,1900,3.1],
  ['SKU-019','Mantequilla 250g','LecheSur','Lácteos',6200,3600,2.5],
  ['SKU-020','Crema de Leche 200ml','LecheSur','Lácteos',3100,1700,2.0],
  ...
  ['SKU-032','Cafe Molido 250g','CafeBueno','Café',12500,7800,9.5],
  ['SKU-033','Cafe Instantaneo 100g','CafeBueno','Café',8200,4500,6.0],
  ['SKU-034','Cafe en Grano 500g','CafeBueno','Café',24000,14000,4.5],
  ['SKU-035','Cafe Descafeinado 250g','CafeBueno','Café',13800,8200,3.0],
  ['SKU-036','Cafe Capsula x10','CafeBueno','Café',15000,8800,2.5],
  ['SKU-037','Chocolate Caliente 200g','CafeBueno','Chocolates',6500,3600,1.8],
  ['SKU-038','Azucar Blanca 1kg','DulceSol','Azúcar',3100,1900,7.0],
  ['SKU-039','Azucar Morena 1kg','DulceSol','Azúcar',3600,2100,4.0],
  ['SKU-040','Panela Pulverizada 500g','DulceSol','Azúcar',2800,1600,3.5],
  ['SKU-041','Miel de Abejas 350ml','DulceSol','Azúcar',14500,8200,2.2],
  ['SKU-042','Stevia en Sobres x100','DulceSol','Azúcar',8900,5100,1.8],
  ['SKU-043','Azucar Glass 250g','DulceSol','Azúcar',2500,1400,1.2],
  ...
  ['SKU-055','Jugo de Naranja 1L','VitaFresh','Jugos',5800,3200,6.5],
  ['SKU-056','Jugo de Manzana 1L','VitaFresh','Jugos',6200,3500,4.0],
  ['SKU-057','Agua Mineral 600ml','VitaFresh','Agua',1800,900,3.5],
  ['SKU-058','Gaseosa Lima 1.5L','VitaFresh','Gaseosas',4500,2200,2.8],
  ['SKU-059','Té Verde Botella 500ml','VitaFresh','Tés',3200,1700,2.0],
  ['SKU-060','Bebida Isotonica 600ml','VitaFresh','Hidratantes',4800,2500,1.5],
  ...
  ['SKU-067','Pan Tajado Integral','PanDorado','Panadería',5200,2800,4.0],
  ['SKU-068','Tostadas Multigrano x12','PanDorado','Panadería',4600,2500,2.8],
  ['SKU-069','Hamburguesa Res x4','CarneSelect','Cárnicos',12500,7200,5.5],
  ['SKU-070','Salchicha Premium x6','CarneSelect','Cárnicos',8900,4800,3.8],
  ['SKU-071','Pechuga de Pollo 500g','PolloFresco','Cárnicos',11200,6500,6.0],
  ['SKU-072','Nuggets de Pollo x12','PolloFresco','Cárnicos',9500,5200,3.5],
  ...
  ['SKU-085','Pañales Talla M x30','BebeStar','Bebés',28000,15500,7.0],
  ['SKU-086','Toallitas Humedas x80','BebeStar','Bebés',9800,5200,3.8],
...
// Nombres canónicos con tildes (alineado con prisier-admin SEED_R010).
const RETAILERS = ['Éxito', 'Jumbo', 'Olímpica', 'D1', 'Ara', 'Carulla']
...
const catAtribRaw: [string, string[], number[], number[]][] = [
  ...
  ['Lácteos',['Calidad','Disponibilidad','Marca','Frescura','Presentación'],[0.25,0.25,0.20,0.20,0.10],[4,4,3,4,3]],
  ...
  ['Café',['Aroma','Marca','Origen','Disponibilidad','Precio'],[0.30,0.25,0.20,0.15,0.10],[4,4,4,3,3]],
  ['Jugos',['Sabor','Contenido de fruta','Precio','Empaque','Disponibilidad'],[0.30,0.25,0.20,0.15,0.10],[4,4,3,3,4]],
  ['Agua',['Precio','Disponibilidad','Empaque','Pureza','Marca'],[0.30,0.25,0.20,0.15,0.10],[4,4,3,4,3]],
  ['Gaseosas',['Sabor','Precio','Disponibilidad','Empaque','Marca'],[0.30,0.25,0.20,0.15,0.10],[4,4,4,3,3]],
  ['Tés',['Sabor','Variedad','Precio','Empaque','Disponibilidad'],[0.30,0.25,0.20,0.15,0.10],[4,3,4,3,3]],
  ['Hidratantes',['Sabor','Electrolitos','Precio','Disponibilidad','Marca'],[0.30,0.25,0.20,0.15,0.10],[4,4,4,3,3]],
  ['Azúcar',['Calidad','Disponibilidad','Marca','Presentación','Precio'],[0.30,0.25,0.20,0.15,0.10],[3,4,3,3,3]],
  ...
  ['Panadería',['Calidad','Frescura','Marca','Disponibilidad','Presentación'],[0.25,0.25,0.20,0.20,0.10],[4,4,3,3,3]],
  ['Cárnicos',['Calidad','Frescura','Marca','Disponibilidad','Presentación'],[0.30,0.25,0.20,0.15,0.10],[4,4,3,3,3]],
  ...
  ['Bebés',['Calidad','Marca','Disponibilidad','Innovación','Presentación'],[0.30,0.25,0.20,0.15,0.10],[4,4,3,3,3]],
...
// Margen en decimal 0–1 (alineado con prisier-admin SEED_R007).
// IVA en decimal 0–1.
